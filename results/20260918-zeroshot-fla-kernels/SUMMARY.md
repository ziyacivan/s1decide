...
- **Commit**: `72ca898d9d82` **(tree dirty at run time)**
- **Created**: 2026-09-17T22:04:11+00:00 · Windows 10 · Python 3.11.16

> **Kernels not recorded — torch fallback.** This run predates kernel reporting; on the reference machine that means the gated-deltanet layers ran the torch implementation. Compare it only with other runs carrying the same note.
